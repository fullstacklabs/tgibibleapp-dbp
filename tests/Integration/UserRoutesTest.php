...
class UserRoutesTest extends ApiV4Test
{
    ...
    public function updateUser()
    {
        ...
        $response = $this->withHeaders($this->params)->put($path, [
          'notes' => 'A user updated by Feature tests',
          'email' => $new_user_data['email'], // email is required but since delete isn't working, keep it the same
        ]);
     ...
     * @test
     */
    public function verifyUpdateUser()
    {
        global $new_user_data;
        $path = route('v4_user.show', array_merge([
          'user_id' => $new_user_data['id'],
    ...
    public function users()
    {
        ...
        $response = $this->withHeaders($this->params)->put($path, [
          'notes' => 'A user updated by Feature tests',
          'email' => $new_user['email'], // email is required but since delete isn't working, keep it the same
        ]);
